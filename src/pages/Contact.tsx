              ...
              <div className="quote-summary">
                ...
                {hasOutOfStockItems && (
                  <p className="quote-summary__note">
                    ...
                    products are currently marked as Contact for availability.
                    This request will be sent as an availability / quotation
                    enquiry rather than an order — our team will confirm lead
                    time and pricing.
                  </p>
                )}
              </div>
