...
//               <div>
//                 <span>WEBSITE</span>
//                 <strong>labnovascientific.com.au</strong>
//               </div>
//               <div>
//                 <span>PHONE</span>
              ...
              <div className="quote-summary">
                  ...
                  <div className="quote-mini" key={product.id}>
                    ...
                    <div>
                      <strong>
                        {product.name}
                        {!product.inStock && (
                          <em className="quote-mini__tag">Out of stock</em>
                        )}
                      </strong>
                      <span>
                        {Object.entries(line.quantities)
                ...
                {hasOutOfStockItems && (
                  <p className="quote-summary__note">
                    <Icon name="alert" size={14} /> One or more selected
                    products are currently out of stock. This request will be
                    sent as an availability / quotation enquiry rather than an
                    order — our team will confirm lead time and pricing.
                  </p>
                )}
              </div>
            )}
