...
//                           Quote only — Contact for availability
//                         </em>
//                       )}
//                     </div>
//                     <button
...
//             {hasOutOfStockItems && (
//               <p className="cart-summary__note">
//                 One or more items are currently marked as Contact for
//                 availability — this will be sent as an availability / quotation
//                 enquiry.
//               </p>
//             )}
//             <p>
                ...
                <div className="cart-line__main">
                  <div className="cart-line__title">
                    <div>
                      ...
                      >
                        <small style={{ margin: 0 }}>{product.sku}</small>
                        {!product.inStock && (
                          <span
