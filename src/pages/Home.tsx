...
// //         <div className="why-intro">
// //           <span className="eyebrow">Built on precision</span>
// //           <h2>Confidence at every point of your workflow.</h2>
// //           {/*
// //             Added inline styles here to override the global justify rule.
// //             This perfectly centers the text on all screen sizes.
// //           */}
        ...
        <section className="category-tiles-section section-wrap">
          ...
          <div className="category-tiles">
            {categories.map((c) => (
              ...
              >
                <span className="category-tile__icon">
                  {/* Reduced icon size from 22 to 20 for a tighter look */}
                  <Icon name={CATEGORY_ICONS[c.slug] || "grid"} size={20} />
                </span>
                <span className="category-tile__body">
                  <strong>{c.name}</strong>
                  <span>
