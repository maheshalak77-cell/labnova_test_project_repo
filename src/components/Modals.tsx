      ...
      >
        ...
        {!product.inStock && (
          <div className="stock-note">
            <Icon name="alert" size={15} /> This item is currently marked as
            Contact for availability — your request will be sent as an
            availability / quotation enquiry, not an order.
          </div>
        )}
